...
from apis import public, user, sys_log, upload, echarts, role, resource, room, product
...
def register_router(app: FastAPI):
    ...
    # 直播间
    app.include_router(room.router, prefix=settings.API_PREFIX + "/room", tags=["Room"])

    # 商品
    app.include_router(product.router, prefix=settings.API_PREFIX + "/product", tags=["Product"])
